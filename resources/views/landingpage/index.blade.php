						...
						<div class="container">
							...
							<div class="d-flex align-items-center justify-content-between">
								...
								<div class="d-flex align-items-center flex-equal">
									...
									<!--begin::Logo image-->
									<a href="landing.html">
										<img alt="Logo" src="assets/media/logos/logosimrsatas.png" class="logo-default h-25px h-lg-30px" />
										<img alt="Logo" src="assets/media/logos/logosimrsatas.png" class="logo-sticky h-20px h-lg-25px" />
									</a>
									<!--end::Logo image-->
								</div>
								<!--end::Logo-->
						...
						<div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
							...
							<h1 class="text-white lh-base fw-bold fs-2x fs-lg-3x mb-15">
                                <span style="background: linear-gradient(to right, #12CE5D 0%, #FFD80C 100%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">
                                    <span id="kt_landing_hero_text">Sistem Informasi Management Rumah Sakit</span>
                                </span>
							<br />Kelompok 2
                            </h1>
							<!--end::Title-->
                            <!-- Highlight 1 -->
                            <div class="mb-17">
                                <div class="highlight d-flex flex-stack flex-md-nowrap card-rounded shadow p-8 p-lg-12 mb-n5 mb-lg-n13" style="background: linear-gradient(90deg, #20AA3E 0%, #03A588 100%);">
                                    <!-- Content -->
                                    <div class="my-2 me-5">
                                        <!-- Title -->
                                    ...
                                    <!-- Link -->
                                    <a href="{{ route('regispasien.index') }}" class="btn btn-lg btn-outline border-2 btn-outline-white flex-shrink-0 my-2">Registrasi</a>
                                </div>
                            </div>
                            <!-- End Highlight 1 -->
                            ...
                            <!-- Highlight 2 -->
                            <div class="mb-10">
                                <div class="highlight d-flex flex-stack flex-md-nowrap card-rounded shadow p-8 p-lg-12 mb-n5 mb-lg-n13" style="background: linear-gradient(90deg, #3c00ff 0%, #03A588 100%);">
                                    <!-- Content -->
                                    <div class="my-2 me-5">
                                        <!-- Title -->
                                        <div class="fs-1 fs-lg-2qx fw-bold text-white mb-2">Start With Metronic Today,
                                    ...
                                    <!-- Link -->
                                    <a href="{{ route('cekstatusantrian.index') }}" class="btn btn-lg btn-outline border-2 btn-outline-white flex-shrink-0 my-2">Cek Status Antrian</a>
                                </div>
                            </div>
                            <!-- End Highlight 2 -->
						</div>
