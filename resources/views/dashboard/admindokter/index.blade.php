...
<html lang="en">
	...
	<link rel="icon" type="image/x-icon" href="{{ asset('img/halal.ico') }}"/>
	<!--end::Head-->
	<!--begin::Body-->
					...
					<div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
						...
						<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
							...
							<div class="app-navbar flex-shrink-0">
								<!--begin::Search-->
								c<div class="app-navbar-item align-items-stretch ms-1 ms-md-4">
									<!--begin::Search-->
								...
								<div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
									<!--begin::Menu wrapper-->
                                    <a class="text-gray-800 fs-5">Hi, Admin Dokter</a>
											...
											<div class="d-flex flex-column mb-7 fv-row">
												...
												<div class="position-relative">
													...
													<div class="position-absolute translate-middle-y top-50 end-0 me-5">
														...
														<img src="{{ asset('assets/media/svg/card-logos/mastercard.sv') }}g" alt="" class="h-25px" />
