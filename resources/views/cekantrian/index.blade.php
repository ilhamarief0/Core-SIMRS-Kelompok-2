...
<base href="../../" />
	...
	<body id="kt_body" class="app-blank">
								...
								<div class="current" data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="pb-10 pb-lg-15">
											<!--begin::Title-->
											<center>
											<h2 class="fw-bold text-gray-900">Silahkan Cek Status Registrasi Anda!</h2>
											</center>
											<!--end::Title-->
											<!--begin::Notice-->
											<center>
										...
										<div class="mb-10 fv-row r">
											<!--begin::Label-->
											<label class="form-label mb-3 required">No. Registrasi</label>
											<!--end::Label-->
											<!--begin::Input-->
		...
		<script src="assets/js/custom/utilities/modals/cekstatusregis.js"></script>
